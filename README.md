...
# 📖 Rick and Morty API <a name="about-project"></a>

**Rick and Morty** is a website that you can use to search trough the characters of the series.
...
- [Live Demo Link ](https://rickandmortyapiwiki.netlify.app)
...
- Digit "git clone https://github.com/PedroH-Neves/rick-and-morty-api.git"

- Then "cd rick-and-morty-api"
...
Feel free to check the [issues page](https://github.com/PedroH-Neves/rick-and-morty-api/issues).
